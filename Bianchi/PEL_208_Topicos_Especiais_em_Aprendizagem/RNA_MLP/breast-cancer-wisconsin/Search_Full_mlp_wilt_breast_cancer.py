...
def main ():
    ...
    for vSheet in treina.sheet_names():
        ...
        with open(csv_file_name, mode='a', newline='') as csv_file:
            fieldnames = ['cenario', 'qtAcertos_tp1','qtAcertos_tp2', 'qtErros_tp1', 'qtErros_tp2','%']
            ...
            for cenario in range (0,qtCenarios, 1):
                ...
                writer.writerow([configCamadas, tbConf[0][0] , tbConf[1][0] , tbErros[0][0], tbErros[1][0],txAcerto[0]])
