...
class Perceptron(object):
    ...
    ############################### Calcula o primeiro vetor w com numeros aleatórios ##################################
        self.w = np.random.uniform(-0.1, 0.1, dimensoes + 1)
...
def main ():
    ...
    for vSheet in treina.sheet_names():
        print(vSheet)
        csv_file_name="mlp_saida_"+vSheet+".csv"
        with open(csv_file_name, mode='a', newline='') as csv_file:
            ...
            for cenario in range (0,qtCenarios, 1):
                ...
                for ciclos in range (0, maxCheck, 1):
                    ...
                    rna = mlp(layer=configCamadas, α_sat=0.5, η_aprend=aprendizado, dimensoes=np.size(X, 1), episodios=episodios,
                              ε=0.01)
                    ...
                    for i in range(0, np.size(XVal, 0), 1):
                        ...
                        writer.writerow([XVal[i], YVal[i], YPred])
                        for j in range(0, saidas, 1):
                            if YVal[i][j] == YPred[j]:
                                ...
                                if YPred[j] == 0:
                                    tbErros[1] += 1/maxCheck
                                else:
                                    tbErros[0] += 1/maxCheck
                print("\n====================Predicao====================")
                print("================================================")
                ...
                print(tbConf)
                print("================================================")
                txAcerto=(tbConf[0]+tbConf[1])/((tbConf[0]+tbConf[1]) +(tbErros[0]+tbErros[1]))
                print("txAcerto", txAcerto[0])
                print("================================================")
                print("Pesos da Rede Neural Artificial")
                conhecimento=rna.net_w()
                print(rna.net_w())
                print("================================================")
